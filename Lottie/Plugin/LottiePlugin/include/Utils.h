...
namespace LottieExporter
{
	...
	public:
		...
		static std::string cleanScript(std::string& str);

		static std::string removeSpecialChars(std::string str);

		static std::string replaceSpecialChars(std::string str, std::string rep);
		...
		static void FreeString16(FCM::StringRep16 str, FCM::PIFCMCallback pCallback);
